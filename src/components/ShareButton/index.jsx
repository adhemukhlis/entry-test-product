			...
			<div className="social-buttons">
				<a href="#" className="social-button facebook">
					<svg
						...
						<path d="M725.333 149.333A21.333 21.333 0 0 0 704 128H597.333A203.52 203.52 0 0 0 384 320v115.2H277.333A21.333 21.333 0 0 0 256 456.533v110.934a21.333 21.333 0 0 0 21.333 21.333H384v285.867A21.333 21.333 0 0 0 405.333 896h128a21.333 21.333 0 0 0 21.334-21.333V588.8h111.786a21.333 21.333 0 0 0 20.907-15.787l30.72-110.933a21.333 21.333 0 0 0-20.48-26.88H554.667V320a42.667 42.667 0 0 1 42.666-38.4H704a21.333 21.333 0 0 0 21.333-21.333z" />
					</svg>
				</a>
				<a href="#" className="social-button whatsapp">
					<svg xmlns="http://www.w3.org/2000/svg" className="icon" width={60} height={60} viewBox="0 0 1024 1024">
